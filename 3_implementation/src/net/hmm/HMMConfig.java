...
/**
 * This class represents configuration of hidden Markov model (HMM).
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class HMMConfig implements Serializable, Cloneable {
	 ...
	 */
	public void putAll(HMMConfig config) {
