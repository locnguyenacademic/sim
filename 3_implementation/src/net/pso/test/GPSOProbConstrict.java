...
public class GPSOProbConstrict extends PSOImpl {
	...
	public DataConfig createDefaultConfig() {
		...
		config.put(SOCIAL_WEIGHT_LOCAL_FIELD, 2.05);
		config.put(INERTIAL_WEIGHT_FIELD, 1.0);
		config.put(CONSTRICT_WEIGHT_FIELD, 0.7298);
		config.put(CONSTRICT_WEIGHT_PROB_MODE_FIELD, true);
		config.put(NEIGHBORS_FDR_MODE_FIELD, true);
		config.put(NEIGHBORS_FDR_THRESHOLD_FIELD, 2.0);
