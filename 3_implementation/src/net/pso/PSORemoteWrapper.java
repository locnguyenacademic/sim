...
public class PSORemoteWrapper extends NonexecutableAlgRemoteWrapper implements PSO, PSORemote, AllowNullTrainingSet {
	...
	public Function<?> getFunction() throws RemoteException {
		return ((PSORemote)this.remoteAlg).getFunction();
	}


	@Override
	public void setFunction(Function<?> func) throws RemoteException {
		((PSORemote)this.remoteAlg).setFunction(func);
	}


	@Override
	public void setFunction(List<String> varNames, String funcExpr) throws RemoteException {
		((PSORemote)this.remoteAlg).setFunction(varNames, funcExpr);
	}
