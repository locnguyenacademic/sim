...
/**
 * This class represents configuration of neural network.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class NetworkConfig implements Serializable, Cloneable {
	 ...
	 */
	public void putAll(NetworkConfig config) {
