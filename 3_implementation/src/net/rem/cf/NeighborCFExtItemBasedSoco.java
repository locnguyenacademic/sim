...
/**
 * This class sets up item-based neighbor collaborative filtering (Neighbor CF) algorithm with soft cosine.
 *  
 * @author Loc Nguyen
 * @version 12.0
 *
...
public class NeighborCFExtItemBasedSoco extends NeighborCFExtItemBased {
	...
	public NeighborCFExtItemBasedSoco() {
		...
		soco.getConfig().put(Soco.USER_RATING_MATRIX_FIELD, false);
	}
	 ...
	 */
	private NeighborCFExtItemBasedSoco getThisNeighborCF() {
		return this;
	}
