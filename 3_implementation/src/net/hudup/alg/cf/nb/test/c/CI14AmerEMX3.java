...
public class CI14AmerEMX3 extends NeighborCFExtItemBased implements ForTest {
	...
	protected double sim0(String measure, RatingVector vRating1, RatingVector vRating2, Profile profile1,
		...
		return urp * amer(vRating1, vRating2, profile1, profile2) * coco(vRating1, vRating2, profile1, profile2);
	}

	
	@Override
	public String getName() {
		return "CI14.Amer.EMX3";
	}
