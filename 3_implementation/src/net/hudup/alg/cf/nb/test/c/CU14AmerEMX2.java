...
public class CU14AmerEMX2 extends NeighborCFExtUserBased implements ForTest {
	...
	protected double sim0(String measure, RatingVector vRating1, RatingVector vRating2, Profile profile1,
		...
		return urp * amer(vRating1, vRating2, profile1, profile2) * nnsm(vRating1, vRating2, profile1, profile2);
	}

	
	@Override
	public String getName() {
		return "CU14.Amer.EMX2";
	}
