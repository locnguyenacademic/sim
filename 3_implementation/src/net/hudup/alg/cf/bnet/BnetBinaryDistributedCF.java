...
/**
 * This class implements collaborative filtering algorithm based on distributed binary Bayesian networks.
 * 
 * @author Loc Nguyen
 * @version 10.0
 *
...
@NextUpdate
@Deprecated
public class BnetBinaryDistributedCF extends BnetCFAbstract {
	...
	public String getDescription() throws RemoteException {
		// TODO Auto-generated method stub
		return "Distributed clustered binary Bayesian network collaborative filtering algorithm";
	}
...
/**
 * This is knowledge base of collaborative filtering algorithm based on distributed binary Bayesian networks.
 * 
 * @author Loc Nguyen
 * @version 10.0
 *
...
abstract class BnetBinaryDistributedKB extends KBaseAbstract {
	...
	/**
	 * Map of graphs of binary Bayesian networks.
	 */
	...
	/**
	 * Getting map of graphs of binary Bayesian networks.
	...
	protected Map<Integer, List<BnetBinaryGraph>> loadBnet(UriAdapter adapter, xURI store) {
		...
		List<xURI> uriList = BnetCFAbstract.getUriList(store, BNET_FILEEXT, getName(), false);
	...
	/**
	 * Saving Bayesian networks to store.
	 * @param bnetMap map of binary Bayesian networks.
	 ...
	 * @param adapter URI adapter.
	 * @param bg graph of binary Bayesian network.
	 * @param store store URI.
	 * @param algName algorithm name.
	 */
