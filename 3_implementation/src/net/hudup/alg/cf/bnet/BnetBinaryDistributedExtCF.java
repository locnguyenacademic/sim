...
/**
 * This class implements extensive collaborative filtering algorithm based on distributed binary Bayesian networks.
 * 
 * @author Loc Nguyen
 * @version 10.0
 *
...
public class BnetBinaryDistributedExtCF extends BnetBinaryDistributedCF {
	...
	public String getDescription() throws RemoteException {
		// TODO Auto-generated method stub
		return "Extended distributed clustered binary Bayesian network collaborative filtering algorithm";
	}


	/**
	 * Reading Bayesian networks of an item identifier.
	...
	protected List<BnetBinaryGraph> readBayesList(int itemId) {
		...
		List<xURI> uriList = BnetCFAbstract.getUriList(store, 
...
/**
 * This is knowledge base of extensive collaborative filtering algorithm based on distributed binary Bayesian networks.
 * 
 * @author Loc Nguyen
 * @version 10.0
 *
...
abstract class BnetBinaryDistributedExtKB extends KBaseAbstract {
	...
	public void save(DataConfig storeConfig) throws RemoteException {
		...
		if (exportStore.equals(thisStore)) {
			LogUtil.info("Export the same place");
			return;
		}
	...
	/**
	 * Creating Bayesian network from bit data.
	 * @param bitData bit (binary) data.
	 * @param bitId bit item identifier.
	 * @param minprob minimum probability.
	 * @return Bayesian network created from bit data.
	 */
	...
	/**
	 * Create knowledge base of extensive collaborative filtering algorithm based on distributed binary Bayesian network.
	 * @param cf extensive collaborative filtering algorithm based on distributed binary Bayesian network.
	 * @return knowledge base of extensive collaborative filtering algorithm based on distributed binary Bayesian network.
	 */
