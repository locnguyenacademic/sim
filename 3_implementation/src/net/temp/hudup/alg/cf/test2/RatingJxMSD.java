...
/**
 * Rating Jaccard + MSD measure.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class RatingJxMSD extends NeighborCFExtUserBased implements ForTest {
	...
	protected String getDefaultMeasure() {
		return "a03.06.04.01.ratingjxmsd";
	}
	...
	protected double sim0(String measure, RatingVector vRating1, RatingVector vRating2, Profile profile1,
		...
		return jaccardRating(vRating1, vRating2, profile1, profile2) * msdNormal(vRating1, vRating2, profile1, profile2);
	}
