...
/**
 * Rating Jaccard + NHSM measure.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class RatingJxNHSM extends NeighborCFExtUserBased implements ForTest {
	...
	protected String getDefaultMeasure() {
		return "a03.06.05.02.ratingjxnhsm";
	}
	...
	protected double sim0(String measure, RatingVector vRating1, RatingVector vRating2, Profile profile1,
		...
		return jaccardRating(vRating1, vRating2, profile1, profile2) * amert * urp;
	}
