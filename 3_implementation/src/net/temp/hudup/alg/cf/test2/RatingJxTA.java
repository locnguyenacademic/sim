...
/**
 * Rating Jaccard + TA measure.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class RatingJxTA extends NeighborCFExtUserBased implements ForTest {
	...
	protected String getDefaultMeasure() {
		return "a03.06.10.01.ratingjxta";
	}
	...
	protected double sim0(String measure, RatingVector vRating1, RatingVector vRating2, Profile profile1,
		...
		return jaccardRating(vRating1, vRating2, profile1, profile2) * triangleArea(vRating1, vRating2, profile1, profile2);
	}
