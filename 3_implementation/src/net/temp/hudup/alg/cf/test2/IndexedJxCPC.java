...
/**
 * Indexed Jaccard + CPC measure.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class IndexedJxCPC extends NeighborCFExtUserBased implements ForTest {
	...
	protected String getDefaultMeasure() {
		return "a03.07.02.02.indexedjxcpc";
	}
	...
	protected double sim0(String measure, RatingVector vRating1, RatingVector vRating2, Profile profile1,
		...
		return jaccardIndexed(vRating1, vRating2, profile1, profile2) * cpc(vRating1, vRating2, profile1, profile2);
	}
