...
/**
 * Rating Jaccard + Cosine measure.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class RatingJxCosine extends NeighborCFExtUserBased implements ForTest {
	...
	protected String getDefaultMeasure() {
		return "a03.06.01.01.ratingjxcosine";
	}
	...
	protected double sim0(String measure, RatingVector vRating1, RatingVector vRating2, Profile profile1,
		...
		return jaccardRating(vRating1, vRating2, profile1, profile2) * cosineNormal(vRating1, vRating2, profile1, profile2);
	}
