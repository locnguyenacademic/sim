...
/**
 * Indexed Jaccard + Cosine measure.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class IndexedJxCosine extends NeighborCFExtUserBased implements ForTest {
	...
	protected String getDefaultMeasure() {
		return "a03.07.01.01.indexedjxcosine";
	}
	...
	protected double sim0(String measure, RatingVector vRating1, RatingVector vRating2, Profile profile1,
		...
		return indexedJaccard(vRating1, vRating2, profile1, profile2) * cosineNormal(vRating1, vRating2, profile1, profile2);
	}
