...
/**
 * Indexed Jaccard + NHSM measure.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class IndexedJxNHSM extends NeighborCFExtUserBased implements ForTest {
	...
	protected String getDefaultMeasure() {
		return "a03.07.05.02.indexedjxnhsm";
	}
