...
/**
 * Indexed Jaccard + MSD measure.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class IndexedJxMSD extends NeighborCFExtUserBased implements ForTest {
	...
	protected String getDefaultMeasure() {
		return "a03.07.04.01.indexedjxmsd";
	}
	...
	protected double sim0(String measure, RatingVector vRating1, RatingVector vRating2, Profile profile1,
		...
		return jaccardIndexed(vRating1, vRating2, profile1, profile2) * msdNormal(vRating1, vRating2, profile1, profile2);
	}
