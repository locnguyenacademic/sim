...
import static net.temp.rem.RegressionEMImpl.REM_LOOP_BALANCE_MODE_DEFAULT;
import static net.temp.rem.RegressionEMImpl.REM_LOOP_BALANCE_MODE_FIELD;
 ...
 */
@Deprecated
public abstract class MutualRegressionEM extends ExponentialEM implements RM, DuplicatableAlg {
	 ...
	 */
	protected static List<Double> calcResidualWeights(List<RegressionEMImpl> rems, Fetcher<Profile> inputSample) throws RemoteException {
	...
	protected List<Double> calcRegressWeights(List<RegressionEMImpl> rems, Fetcher<Profile> inputSample) throws Exception {
		...
		AttributeList attRef = AttributeList.defaultRealVarAttributeList(rems.size() + 1);
